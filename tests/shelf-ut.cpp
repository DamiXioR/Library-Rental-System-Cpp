...
TEST_F(TestShelf, MethodGetStringStreamWithAllBooksOnTheShelfShoudReturnSStreamWithLoadedBooksData){
	...
	expectedStringStream <<"Author: " << "Tolkien" << " Title: " << "Lord of the rings" << " Kind: " << "Fantasy" << " Date: " << 2021 << " ID: " << idLordOfTheRings << ";";
	expectedStringStream <<"Author: " << "Herbert" << " Title: " << "Diuna" << " Kind: " << "Fantasy" << " Date: " << 2019 << " ID: " << idDiuna << ";";
	expectedStringStream <<"Author: " << "Simmons" << " Title: " << "Hyperion" << " Kind: " << "Fantasy" << " Date: " << 2018 << " ID: " << idHyperion << ";";
